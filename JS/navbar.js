...
function loadNavbar(){
    ...
    navInner += `
    <div class="nav_bar">
      <button class="nav_but"><a href="../HTML/openingpage.htm">HOME</a></button>
      ...
      <button class="nav_but"><a href="../HTML/loginSelect.html">LOGIN</a></button>
      <div class="topnav_right">
          <button class="nav_but"><a href="../HTML/about-page.html">ABOUT</a></button>
      </div>
    </div>
    `
